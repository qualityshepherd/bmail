...
const TABLES = [
  ['emails', ['id', 'sender', 'recipient', 'subject', 'body', 'message_id', 'in_reply_to', 'notify', 'created_at', 'sender_display', 'starred', 'status', 'status_changed_at', 'read', 'tags', 'cc']],
  ...
  ['allowed_notifications', ['id', 'pattern', 'kind']],
